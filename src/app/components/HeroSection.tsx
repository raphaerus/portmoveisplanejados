      ...
      <div className="hero-content flex-col lg:flex-row-reverse gap-12 lg:gap-24 w-full justify-between">
        ...
        <div className="relative mt-8 lg:mt-0">
          ...
          <div className="w-[320px] h-[420px] md:w-[400px] md:h-[500px] bg-plantBeige rounded-t-full relative flex items-end justify-center mx-auto">
            ...
            {/* Imagem da Planta (Do clientData) */}
            <div className="relative w-[90%] h-[90%] mb-4">
              <Image
                src={clientData.hero.bgImage}
                alt={clientData.hero.title}
                fill
            ...
            {/* Bolinha do Preço (Opcional - Removido ou Dinâmico) */}
        ...
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <a href="#projetos" className="btn bg-plantTerracotta hover:bg-plantTerracotta/90 text-white border-none rounded-full px-8 h-14 text-base normal-case flex items-center gap-3 mx-auto lg:mx-0 shadow-lg w-fit">
            Ver Projetos <FiArrowRight className="text-xl" />
          </a>
        </div>
